...
#define LL_ATON_NETWORK_ORIGIN_MODEL_NAME   "yolov8n_256_quant_pc_uf_pose_cocost"

/************************** USER ALLOCATED IOs ********************************/
#define LL_ATON_NETWORK_USER_ALLOCATED_INPUTS   (1)  // Number of input buffers not allocated by the compiler
#define LL_ATON_NETWORK_USER_ALLOCATED_OUTPUTS  (1)  // Number of output buffers not allocated by the compiler
...
#define LL_ATON_NETWORK_OUT_1_SIZE_BYTES  (301056)
